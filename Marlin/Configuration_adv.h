...
#define CONFIGURATION_ADV_H_VERSION 190218
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_LENGTH 4.5         // Initial retract in mm
  ...
  #define FILAMENT_CHANGE_LOAD_FEEDRATE 300     // Load filament feedrate in mm/s - filament loading into the bowden tube can be fast
  #define FILAMENT_CHANGE_LOAD_LENGTH 1000       // Load filament length over hotend in mm
                                              // Longer length for bowden printers to fast load filament into whole bowden tube over the hotend,
                                              // Short or zero length for printers without bowden where loading is not used
  #define ADVANCED_PAUSE_EXTRUDE_FEEDRATE 50   // Extrude filament feedrate in mm/s - must be slower than load feedrate
