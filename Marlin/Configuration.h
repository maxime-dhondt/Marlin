...
#define CONFIGURATION_H_VERSION 190218
 ...
 */
#define TEMP_SENSOR_0 17 //valeur thermistor DE200
...
#define PID_K1 0.95      // Smoothing factor within the PID
  ...
  // Ultimaker
  #define  DEFAULT_Kp 32.48 //valeurs firmware d'origine par dago
...
#define EXTRUDE_MINTEMP 160 //abaissé à 160

// This option prevents a single extrusion longer than EXTRUDE_MAXLENGTH.
// Note that for Bowden Extruders a too-small value here may prevent loading.
//#define PREVENT_LENGTHY_EXTRUDE
//#define EXTRUDE_MAXLENGTH 200 //pas de protection d'extrusion
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2560, 100.5}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 3, 170 } 
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 21  // Y offset: -front +behind [the nozzle] //ecart dago
...
#define HOMING_FEEDRATE_Z  150 //axe z qui claque
